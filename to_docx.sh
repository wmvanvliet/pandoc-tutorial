...
pandoc -s beamformer_framework_pandoc.tex -f latex+raw_tex --citeproc --bibliography beamformer_framework.bib --resource-path ./paper -o beamformer_framework.json
